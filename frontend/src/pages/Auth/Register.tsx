      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Input label={t("auth.password")} type="password" value={form.password} onChange={update("password")} icon={<Lock className="w-4 h-4" />} placeholder="••••••••" required />
            <Input label={t("auth.confirm_password")} type="password" value={form.confirm_password} onChange={update("confirm_password")} icon={<Lock className="w-4 h-4" />} placeholder="••••••••" required />
